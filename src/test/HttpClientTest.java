...
public class HttpClientTest {
    ...
    public void ttt() throws InterruptedException {
        ...
        for (int i = 0; i < 1000; i++) {
            Request request = new Request.Builder().url("https://api.mpyouzi.com/api/h5/ma/url_scheme?pathId=62d7a1d9f7497f37ea10382e")
                    .addHeader("User-Agent", "fire11chao" + i).build();//2.定义一个request
